...
if BUILD_MODE == 'py2exe':
    ...
    setup(
        ...
        windows=[{'script': 'web2py.py',
                  ...
                  'dest_base': 'web2py_no_console'
                  # MUST NOT be just 'web2py' otherwise it overrides the standard web2py.exe
                  }],
        name="web2py",
...
if python_version > (2, 5):
    ...
    try:
        ...
        print
        "You MUST copy Microsoft.VC90.CRT folder into the archive"
...
if remove_msft_dlls:
    print
    "Deleted Microsoft files not licensed for open source distribution"
    print
    "You are still responsible for making sure you have the rights to distribute any other included files!"
...
if copy_apps:
    ...
    print
    "Only web2py's admin, examples & welcome applications have been added"
...
if make_zip:
    ...
    print
    "Your Windows binary version of web2py can be found in " + \
    zip_filename + ".zip"
    print
    "You may extract the archive anywhere and then run web2py/web2py.exe"
...
if not make_zip and not remove_build_files:
    print
    "Your Windows binary & associated files can also be found in /dist"

print
"Finished!"
print
"Enjoy web2py " + web2py_version_line
